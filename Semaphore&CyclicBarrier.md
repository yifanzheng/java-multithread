# Semaphore&CyclicBarrier 实现同步通信

### Semaphore 信号灯
- Semaphore 可以维护当前访问自身的线程个数，并提供了同步机制，使用 Semaphore 可以控制访问资源的线程个数。
- 单个信号量的 Semaphore 对象可以实现互斥锁（Synchronized）的功能，并且可以是由一个线程获得了“锁”，再由另一个线程的释放，这可应用于死锁恢复的场合。
